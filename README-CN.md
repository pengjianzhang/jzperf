...
## 限制
 - jzperf 要求HTTP消息在一个数据包中，所以不适合7层负载均衡的测试。
 - jzperf 要求独占使用网络接口。
 - jzperf 没有路由功能。建议配合三层交换机搭建测试环境。

## 作者
* Jianzhang Peng

## 许可
jzperf基于 [Apache License, Version 2.0](https://www.apache.org/licenses/LICENSE-2.0) 许可证。
