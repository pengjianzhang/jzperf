 ...
 * Copyright (c) 2022 Jianzhang Peng. All Rights Reserved.
 *
...
#define CTL_CLIENT_LOG LOG_DIR"/jzperf-ctl-client.log"
#define CTL_SERVER_LOG LOG_DIR"/jzperf-ctl-server.log"
